 ...
 * 
 */
@WebServiceClient(name = "ServicesService", targetNamespace = "http://Server", wsdlLocation = "http://localhost:7001/DcuS/services/Services?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICESSERVICE_QNAME = new QName("http://Server", "ServicesService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7001/DcuS/services/Services?wsdl");
    ...
    public Services getServices() {
        return super.getPort(new QName("http://Server", "Services"), Services.class);
    }
    ...
    public Services getServices(WebServiceFeature... features) {
        return super.getPort(new QName("http://Server", "Services"), Services.class, features);
    }
