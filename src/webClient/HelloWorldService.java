 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://example/", wsdlLocation = "http://localhost:7001/JAX_WS_Sample_Project/services/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:7001/JAX_WS_Sample_Project/services/HelloWorld?wsdl");
