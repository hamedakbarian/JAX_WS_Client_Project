 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://example", wsdlLocation = "http://localhost:7001/Apache_Axis_Sample/services/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:7001/Apache_Axis_Sample/services/HelloWorld?wsdl");
    ...
    public HelloWorld getHelloWorld() {
        return super.getPort(new QName("http://example", "HelloWorld"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorld(WebServiceFeature... features) {
        return super.getPort(new QName("http://example", "HelloWorld"), HelloWorld.class, features);
    }
